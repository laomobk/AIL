...
IMPORT_NAME = _register_opcode(108, 'IMPORT_NAME')
IMPORT_FROM = _register_opcode(109, 'IMPORT_FROM')
JUMP_FORWARD = _register_opcode(110, 'JUMP_FORWARD')
JUMP_IF_FALSE_OR_POP = _register_opcode(111, 'JUMP_IF_FALSE_OR_POP')
JUMP_IF_TRUE_OR_POP = _register_opcode(112, 'JUMP_IF_TRUE_OR_POP')
JUMP_ABSOLUTE = _register_opcode(113, 'JUMP_ABSOLUTE')
POP_JUMP_IF_FALSE = _register_opcode(114, 'POP_JUMP_IF_FALSE')
POP_JUMP_IF_TRUE = _register_opcode(115, 'POP_JUMP_IF_TRUE')
LOAD_GLOBAL = _register_opcode(116, 'LOAD_GLOBAL')
SETUP_FINALLY = _register_opcode(122, 'SETUP_FINALLY')
LOAD_FAST = _register_opcode(124, 'LOAD_FAST')
STORE_FAST = _register_opcode(125, 'STORE_FAST')
DELETE_FAST = _register_opcode(126, 'DELETE_FAST')
RAISE_VARARGS = _register_opcode(130, 'RAISE_VARARGS')
CALL_FUNCTION = _register_opcode(131, 'CALL_FUNCTION')
MAKE_FUNCTION = _register_opcode(132, 'MAKE_FUNCTION')
BUILD_SLICE = _register_opcode(133, 'BUILD_SLICE')
LOAD_CLOSURE = _register_opcode(135, 'LOAD_CLOSURE')
LOAD_DEREF = _register_opcode(136, 'LOAD_DEREF')
STORE_DEREF = _register_opcode(137, 'STORE_DEREF')
DELETE_DEREF = _register_opcode(138, 'DELETE_DEREF')
CALL_FUNCTION_KW = _register_opcode(141, 'CALL_FUNCTION_KW')
CALL_FUNCTION_EX = _register_opcode(142, 'CALL_FUNCTION_EX')
SETUP_WITH = _register_opcode(143, 'SETUP_WITH')
EXTENDED_ARG = _register_opcode(144, 'EXTENDED_ARG')
LIST_APPEND = _register_opcode(145, 'LIST_APPEND')
SET_ADD = _register_opcode(146, 'SET_ADD')
MAP_ADD = _register_opcode(147, 'MAP_ADD')
LOAD_CLASSDEREF = _register_opcode(148, 'LOAD_CLASSDEREF')
BUILD_LIST_UNPACK = _register_opcode(149, 'BUILD_LIST_UNPACK')
BUILD_MAP_UNPACK = _register_opcode(150, 'BUILD_MAP_UNPACK')
BUILD_MAP_UNPACK_WITH_CALL = _register_opcode(151, 'BUILD_MAP_UNPACK_WITH_CALL')
BUILD_TUPLE_UNPACK = _register_opcode(152, 'BUILD_TUPLE_UNPACK')
BUILD_SET_UNPACK = _register_opcode(153, 'BUILD_SET_UNPACK')
SETUP_ASYNC_WITH = _register_opcode(154, 'SETUP_ASYNC_WITH')
FORMAT_VALUE = _register_opcode(155, 'FORMAT_VALUE')
BUILD_CONST_KEY_MAP = _register_opcode(156, 'BUILD_CONST_KEY_MAP')
BUILD_STRING = _register_opcode(157, 'BUILD_STRING')
BUILD_TUPLE_UNPACK_WITH_CALL = _register_opcode(158, 'BUILD_TUPLE_UNPACK_WITH_CALL')
LOAD_METHOD = _register_opcode(160, 'LOAD_METHOD')
CALL_METHOD = _register_opcode(161, 'CALL_METHOD')
CALL_FINALLY = _register_opcode(162, 'CALL_FINALLY')
POP_FINALLY = _register_opcode(163, 'POP_FINALLY')
